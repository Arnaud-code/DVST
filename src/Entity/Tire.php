...
class Tire
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=User::class, inversedBy="tire")
     * @ORM\JoinColumn(nullable=false)
     */
    private $user;

    /**
     * @ORM\OneToMany(targetEntity=PressureRecord::class, mappedBy="tire")
     */
    ...
    public function removePressureRecord(PressureRecord $pressureRecord): self
    {
        if ($this->pressureRecords->removeElement($pressureRecord)) {
            ...
            if ($pressureRecord->getTire() === $this) {
                $pressureRecord->setTire(null);
            }
        }
